		...
		return (
			<div className="home">
				...
				<h1
					...
					style={{ marginTop: "1.5em", marginBottom: "0.7em" }}
				>
					<b>
						{!login
				...
				<div className="container-description-flex">
					<div className="left_align left_align-space">
						Instantly book highly rated pros for cleaning and handyman tasks at
						a fixed price.
					</div>
					<Link to="./services" className="right-align-jump">
						See All >
					</Link>
				</div>
				...
				<div className="container-description-flex">
					<div className="left_align-space">
						Everything you buy from Handy comes with free delivery and
						professional installation included.
					</div>
					<Link to="./shop" className="right-align-jump">
						See All >
					</Link>
				</div>
