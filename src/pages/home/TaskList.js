...
export default function TaskList({renderTask}) {
    ...
    return (
        <ul className="list__layout">
            ...
            {renderTask("https://farm5.staticflickr.com/4274/34782221546_bfe8b655c7.jpg","TV Mounting >",'./services/tv')}
            {renderTask("https://i.ytimg.com/vi/0f-GrG-VxVo/maxresdefault.jpg","Wall Hanging >",'./services/moving')}
        </ul>
    )
}
