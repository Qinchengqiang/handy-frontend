  ...
  const renderLi = ( listName, listDescription, img) => {
    return (
     <li className="handy-explain-list" key={listName}>
         <div className="handy-explain-list_img">
             <img src={img} className='handy-explain-list_img_icon' alt={listName}/>
         </div>
         <div className="handy-explain-list_name">{listName}</div>
         <div className="handy-explain-list_description">{listDescription}</div>
     </li>
    )
  }
